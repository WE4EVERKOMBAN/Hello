...
bot.telegram.sendMessage(pData[0].inviter, '➕ *New Referral on your link* you received ' + ref_bonus + ' ' + bot_cur, { parse_mode: 'markdown' })
            ...
            ctx.replyWithMarkdown(
              `*🎉 I am your friendly `+airdropName+` Airdropbot*\n\n*✅ Please complete all the tasks and submit details correctly to be eligible for the airdrop*\n\n💠 Join *`+airdropName+`* Telegram [Group](https://t.me/Cash_Looterr) and [Channel](https://t.me/Cash_Looterr)\n💠 Follow *`+airdropName+`* on [Twitter](https://twitter.com/ChillarCash), Like and Retweet pinned post\n💠 Subscribe to *`+airdropName+`* [Youtube](https://www.youtube.com/c/giveawaydetective)\n💠 Join *promoter* [group](https://t.me/Cash_Looterr) and [channel](https://t.me/Cash_Looterr)\n\n*ℹ️ You must complete all task then click "Submit My Details" button*`, { reply_markup: { keyboard: [['📘 Submit my details']], resize_keyboard: true } }
            )
...
🔗 Your Refer Link : https://t.me/ImpulseXAirdrop_Bot?start=${ctx.from.id}
...
bot.hears('📘 Submit my details', ctx => {
  var kkc = `🔹Join *`+airdropName+`* Telegram [Channel](https://t.me/Cash_Looterr) And [Group](https://t.me/Cash_Looterr) 
...
🔹 Join Cubic Drops Telegram</b> <a href="https://t.me/Cash_Looterr">Channel</a><b>
🔹 Join Cubic Drops Telegram</b> <a href="https://t.me/Cash_Looterr">Group</a><b>
